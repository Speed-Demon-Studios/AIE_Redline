...
public class ShipsControls : MonoBehaviour
{
    ...
    private void Brake()
    {
        ...
        if (PAC != null)
        {
            ...
            PAC.UpdateVolume(0, 0.03f, 0.36f, true, false, true, 0.1f);                                                                              // Engine sound that is first  in the list  (Index [0]), Updating Volume, Subtracting 0.03f from the volume  value over time, capping the minimum at 0.29f.
            ...
            PAC.UpdateVolume(1, 0.03f, 0.15f, true, false, true, 0.1f);                                                                              // Engine sound that is Second in the list  (Index [1]), Updating Volume, Subtracting 0.03f from the volume  value over time, capping the minimum at 0.29f.
            ...
            PAC.UpdateVolume(2, 0.03f, 0.41f, true, false, true, 0.1f);                                                                              // Engine sound that is third  in the list  (Index [2]), Updating Volume, Subtracting 0.03f from the volume  value over time, capping the minimum at 0.29f.
        }
    }
    ...
    private void Accelerate()
    {
        ...
        if (m_accelerateMultiplier == 0 && m_brakeMultiplier == 0 && !m_isBoosting)
        {
            ...
            if (PAC != null)
            {
                ...
                PAC.UpdateVolume(0, 0.01f, 0.36f, true, false, true, 0.1f);                                                                          // Engine sound that is first  in the list  (Index [0]), Updating Volume, subtracting 0.01f from the volume value over time, capping the minimum at 0.29f.
                ...
                PAC.UpdateVolume(1, 0.01f, 0.15f, true, false, true, 0.1f);                                                                          // Engine sound that is Second in the list  (Index [1]), Updating Volume, subtracting 0.01f from the volume value over time, capping the minimum at 0.29f.
                ...
                PAC.UpdateVolume(2, 0.01f, 0.41f, true, false, true, 0.1f);                                                                          // Engine sound that is third  in the list  (Index [2]), Updating Volume, subtracting 0.01f from the volume value over time, capping the minimum at 0.29f.
            }
        }
        else
        {
            ...
            {
                // Audio Pitch & Volume Modulation
                PAC.UpdatePitch(0, 1.1f, 9.5f, true, true, false);                                                                                 // Engine sound that is first  in the list  (Index [0]), Updating Pitch,  adding 0.7f  to the pitch  value over time.
                PAC.UpdateVolume(0, 0.015f, 0.36f, true, true, false, 0.1f);                                                                              // Engine sound that is first  in the list  (Index [0]), Updating Volume, adding 0.015f to the volume value over time.

                PAC.UpdatePitch(1, 1.7f, 19.2f, true, true, false);                                                                                     // Engine sound that is second in the list  (Index [1]), Updating Pitch,  adding 0.7f  to the pitch  value over time.
                PAC.UpdateVolume(1, 0.015f, 0.15f, true, true, false, 0.1f);                                                                              // Engine sound that is Second in the list  (Index [1]), Updating Volume, adding 0.015f to the volume value over time.

                PAC.UpdatePitch(2, 1.1f, 3.6f, true, true, false);                                                                                     // Engine sound that is third  in the list  (Index [2]), Updating Pitch,  adding 0.7f  to the pitch  value over time.
                PAC.UpdateVolume(2, 0.015f, 0.41f, true, true, false, 0.1f);                                                                              // Engine sound that is third  in the list  (Index [2]), Updating Volume, adding 0.015f to the volume value over time.
            }
        }
